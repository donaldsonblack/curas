...
public class UserController {
	...
	@Operation(summary = "List all users (paginated)", description = "Retrieve a paginated list of all users in the system", tags = {
			"User" })
	@GetMapping
	...
	@Operation(summary = "List departments for a user", description = "Retrieve all department memberships for a given user", tags = {
			"User" })
	...
	@Operation(summary = "Get a user by id", description = "Fetch a single user by their unique identifier", tags = {
			"User" })
	@GetMapping("/{id}")
	...
	@Operation(summary = "Create a new user", description = "Create and persist a new user in the system", tags = {
			"User" })
	@PostMapping
	...
	@Operation(summary = "Partially update a user", description = "Partially update the fields of an existing user", tags = {
			"User" })
	@PatchMapping("/{id}")
	...
	@Operation(summary = "Replace or create a user", description = "Replace an existing user or create a new one if it does not exist", tags = {
			"User" })
	@PutMapping("/{id}")
	...
	@Operation(summary = "Delete a user", description = "Delete a user by their unique identifier", tags = { "User" })
	@DeleteMapping("/{id}")
